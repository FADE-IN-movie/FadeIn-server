...
public interface DetailPageService {
  ...
  DetailObject getDetail(String path, String type);
  List<CastObject> getCast(String path);
  List<ContentObject> getSimilarContents(String path);

  DetailPageDTO getDetailPage(Long userId, String type, DetailObject detail, List<CastObject> cast, List<ContentObject> getSimilarContents);
